...
const SingleIOtAppPage = (props) => {
  ...
  const [isHelpSidebarVisible, setHelpSidebarVisible] = useState(false);
    ...
    useEffect(() => {
        ...
        client
            .service("iOtApp")
            .get(urlParams.singleIOtAppId, { query: { $populate: [            {
                path: "createdBy",
                service: "users",
                select: ["name"],
              },{
        ...
        setEnvironment(environment);
            ...
            .catch((error) => {
                console.debug({ error });
                props.alert({ title: "IOtApp", type: "error", message: error.message || "Failed get iOtApp" });
            });
    }, [props,urlParams.singleIOtAppId]);
    ...
    return (
        ...
        <div className="col-12 flex flex-column align-items-center">
            <div className="col-12">
                ...
                {/* <p>iOtApp/{urlParams.singleIOtAppId}</p> */}
            </div>
...
<div className="col-12 md:col-6 lg:col-3"><label className="text-sm text-gray-600">URL</label><p className="m-0 ml-3" >{_entity?.url}</p></div>
      ...
      <CommentsSection
        recordId={urlParams.singleIOtAppId}
        user={props.user}
        alert={props.alert}
        serviceName="iOtApp"
      />
...
export default connect(mapState, mapDispatch)(SingleIOtAppPage);
