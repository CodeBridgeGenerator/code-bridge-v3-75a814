...
const SingleMobileAppPage = (props) => {
  ...
  const [isHelpSidebarVisible, setHelpSidebarVisible] = useState(false);
    ...
    useEffect(() => {
        ...
        client
            .service("mobileApp")
            .get(urlParams.singleMobileAppId, { query: { $populate: [            {
                path: "createdBy",
                service: "users",
                select: ["name"],
              },{
        ...
        setEnvironment(environment);
            ...
            .catch((error) => {
                console.debug({ error });
                props.alert({ title: "MobileApp", type: "error", message: error.message || "Failed get mobileApp" });
            });
    }, [props,urlParams.singleMobileAppId]);
    ...
    return (
        ...
        <div className="col-12 flex flex-column align-items-center">
            <div className="col-12">
                ...
                {/* <p>mobileApp/{urlParams.singleMobileAppId}</p> */}
            </div>
...
<div className="col-12 md:col-6 lg:col-3"><label className="text-sm text-gray-600">URL</label><p className="m-0 ml-3" >{_entity?.url}</p></div>
      ...
      <CommentsSection
        recordId={urlParams.singleMobileAppId}
        user={props.user}
        alert={props.alert}
...
export default connect(mapState, mapDispatch)(SingleMobileAppPage);
