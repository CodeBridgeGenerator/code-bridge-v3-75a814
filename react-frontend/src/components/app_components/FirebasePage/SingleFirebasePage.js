...
const SingleFirebasePage = (props) => {
  ...
  const [isHelpSidebarVisible, setHelpSidebarVisible] = useState(false);
    ...
    useEffect(() => {
        ...
        client
            .service("firebase")
            .get(urlParams.singleFirebaseId, { query: { $populate: [            {
                path: "createdBy",
                service: "users",
                select: ["name"],
              },{
    ...
    }, [props,urlParams.singleFirebaseId]);
    ...
    return (
        ...
        <div className="col-12 flex flex-column align-items-center">
            <div className="col-12">
                ...
                {/* <p>firebase/{urlParams.singleFirebaseId}</p> */}
            </div>
...
<div className="col-12 md:col-6 lg:col-3"><label className="text-sm text-gray-600">Is Default</label><p className="m-0" ><i id="isDefault" className={`pi ${_entity?.isDefault?"pi-check": "pi-times"}`}  ></i></p></div>
      ...
      <CommentsSection
        recordId={urlParams.singleFirebaseId}
        user={props.user}
        alert={props.alert}
...
export default connect(mapState, mapDispatch)(SingleFirebasePage);
