...
const SingleFrontendAppsPage = (props) => {
  ...
  const [isHelpSidebarVisible, setHelpSidebarVisible] = useState(false);
    ...
    useEffect(() => {
        ...
        client
            ...
            .get(urlParams.singleFrontendAppsId, { query: { $populate: [            {
                path: "createdBy",
                service: "users",
                select: ["name"],
              },{
        ...
        setEnvironment(environment);
            ...
            .catch((error) => {
                console.debug({ error });
                props.alert({ title: "FrontendApps", type: "error", message: error.message || "Failed get frontendApps" });
            });
    }, [props,urlParams.singleFrontendAppsId]);


    const goBack = () => {
        navigate("/frontendApps");
    };
        ...
        <div className="col-12 flex flex-column align-items-center">
            <div className="col-12">
                ...
                <div className="flex align-items-center">
                    ...
                    <h3 className="m-0">Frontend Apps</h3>
                    <SplitButton
                ...
                {/* <p>frontendApps/{urlParams.singleFrontendAppsId}</p> */}
            </div>
...
<div className="col-12 md:col-6 lg:col-3"><label className="text-sm text-gray-600">URL</label><p className="m-0 ml-3" >{_entity?.url}</p></div>
      ...
      <CommentsSection
        recordId={urlParams.singleFrontendAppsId}
        user={props.user}
        alert={props.alert}
...
export default connect(mapState, mapDispatch)(SingleFrontendAppsPage);
