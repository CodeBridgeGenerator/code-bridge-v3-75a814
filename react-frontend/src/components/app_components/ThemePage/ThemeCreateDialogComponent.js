...
const ThemeCreateDialogComponent = (props) => {
    ...
    const onSave = async () => {
        if(!validate()) return;
        let _data = {
            themeName: _entity?.themeName,bodyColor: _entity?.bodyColor,emphasisColor: _entity?.emphasisColor,secondaryColor: _entity?.secondaryColor,tertiaryColor: _entity?.tertiaryColor,codeColor: _entity?.codeColor,highlightColor: _entity?.highlightColor,borderColorTranslucent: _entity?.borderColorTranslucent,bodyBg: _entity?.bodyBg,borderColor: _entity?.borderColor,highlightBg: _entity?.highlightBg,secondaryBg: _entity?.secondaryBg,tertiaryBg: _entity?.tertiaryBg,formInvalidBorderColor: _entity?.formInvalidBorderColor,formInvalidColor: _entity?.formInvalidColor,formValidBorderColor: _entity?.formValidBorderColor,formValidColor: _entity?.formValidColor,headingColor: _entity?.headingColor,linkColor: _entity?.linkColor,linkHoverColor: _entity?.linkHoverColor,primary: _entity?.primary,primaryBgSubtle: _entity?.primaryBgSubtle,primaryBorderSubtle: _entity?.primaryBorderSubtle,primaryTextEmphasis: _entity?.primaryTextEmphasis,secondary: _entity?.secondary,secondaryBgSubtle: _entity?.secondaryBgSubtle,secondaryBorderSubtle: _entity?.secondaryBorderSubtle,secondaryTextEmphasis: _entity?.secondaryTextEmphasis,tertiary: _entity?.tertiary,tertiaryBgSubtle: _entity?.tertiaryBgSubtle,tertiaryBorderSubtle: _entity?.tertiaryBorderSubtle,tertiaryTextEmphasis: _entity?.tertiaryTextEmphasis,success: _entity?.success,successBgSubtle: _entity?.successBgSubtle,successBorderSubtle: _entity?.successBorderSubtle,successTextEmphasis: _entity?.successTextEmphasis,info: _entity?.info,infoBgSubtle: _entity?.infoBgSubtle,infoBorderSubtle: _entity?.infoBorderSubtle,infoTextEmphasis: _entity?.infoTextEmphasis,danger: _entity?.danger,dangerBgSubtle: _entity?.dangerBgSubtle,dangerBorderSubtle: _entity?.dangerBorderSubtle,dangerTextEmphasis: _entity?.dangerTextEmphasis,warning: _entity?.warning,warningBgSubtle: _entity?.warningBgSubtle,warningBorderSubtle: _entity?.warningBorderSubtle,warningTextEmphasis: _entity?.warningTextEmphasis,dark: _entity?.dark,darkBgSubtle: _entity?.darkBgSubtle,darkBorderSubtle: _entity?.darkBorderSubtle,darkTextEmphasis: _entity?.darkTextEmphasis,bodyColorRgb: _entity?.bodyColorRgb,emphasisColorRgb: _entity?.emphasisColorRgb,linkColorRgb: _entity?.linkColorRgb,linkHoverColorRgb: _entity?.linkHoverColorRgb,tertiaryColorRgb: _entity?.tertiaryColorRgb,secondaryBgRgb: _entity?.secondaryBgRgb,tertiaryBgRgb: _entity?.tertiaryBgRgb,lightBorderSubtle: _entity?.lightBorderSubtle,lightTextEmphasis: _entity?.lightTextEmphasis,isDefault: _entity?.isDefault || false,
        ...
        const result = await client.service("theme").create(_data);
        props.onHide();
        props.alert({ type: "success", title: "Create info", message: "Info Theme created successfully" });
        props.onCreateResult(result);
        } catch (error) {
            console.debug("error", error);
            setError(getSchemaValidationErrorsStrings(error) || "Failed to create");
            props.alert({ type: "error", title: "Create", message: "Failed to create in Theme" });
        }
        setLoading(false);
    };
    ...
    return (
        <Dialog header="Create Theme" visible={props.show} closable={false} onHide={props.onHide} modal style={{ width: "40vw" }} className="min-w-max scalein animation-ease-in-out animation-duration-1000" footer={renderFooter()} resizable={false}>
            <div className="grid p-fluid overflow-y-auto"
            style={{ maxWidth: "55vw" }} role="theme-create-dialog-component">
