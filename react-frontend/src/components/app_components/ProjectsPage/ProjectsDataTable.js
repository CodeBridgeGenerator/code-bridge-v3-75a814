...
const pTemplate0 = (rowData, { rowIndex }) => <p >{rowData.projectName}</p>
  ...
  const handleHideDialog = () => {
    ...
    return (
        ...
        />
<Column field="projectName" header="Project Name" body={pTemplate0} filter={selectedFilterFields.includes("projectName")} hidden={selectedHideFields?.includes("projectName")}  style={{ minWidth: "8rem" }} />
