...
const SingleGenAiAppPage = (props) => {
  ...
  const [isHelpSidebarVisible, setHelpSidebarVisible] = useState(false);
    ...
    useEffect(() => {
        ...
        client
            .service("genAiApp")
            .get(urlParams.singleGenAiAppId, { query: { $populate: [            {
                path: "createdBy",
                service: "users",
                select: ["name"],
              },{
        ...
        setEnvironment(environment);
            ...
            .catch((error) => {
                console.debug({ error });
                props.alert({ title: "GenAiApp", type: "error", message: error.message || "Failed get genAiApp" });
            });
    }, [props,urlParams.singleGenAiAppId]);
        ...
        <div className="col-12 flex flex-column align-items-center">
            <div className="col-12">
                ...
                <div className="flex align-items-center">
                    ...
                    <h3 className="m-0">Gen Ai App</h3>
                    <SplitButton
                ...
                {/* <p>genAiApp/{urlParams.singleGenAiAppId}</p> */}
            </div>
...
<div className="col-12 md:col-6 lg:col-3"><label className="text-sm text-gray-600">Is Default</label><p className="m-0" ><i id="isDefault" className={`pi ${_entity?.isDefault?"pi-check": "pi-times"}`}  ></i></p></div>
      ...
      <CommentsSection
        recordId={urlParams.singleGenAiAppId}
        user={props.user}
        alert={props.alert}
...
export default connect(mapState, mapDispatch)(SingleGenAiAppPage);
