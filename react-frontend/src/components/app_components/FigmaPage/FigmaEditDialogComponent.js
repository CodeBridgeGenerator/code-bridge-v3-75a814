...
const FigmaCreateDialogComponent = (props) => {
    ...
    const onSave = async () => {
        let _data = {
            name: _entity?.name,
fileId: _entity?.fileId,
description: _entity?.description,
isDefault: _entity?.isDefault,
textBody: _entity?.textBody,
textEmphasis: _entity?.textEmphasis,
textSecondary: _entity?.textSecondary,
textTertiary: _entity?.textTertiary,
textCode: _entity?.textCode,
textHighlight: _entity?.textHighlight,
bgBorderTranslucent: _entity?.bgBorderTranslucent,
bgBody: _entity?.bgBody,
bgBorder: _entity?.bgBorder,
bgHighlight: _entity?.bgHighlight,
bgSecondary: _entity?.bgSecondary,
bgTertiary: _entity?.bgTertiary,
formInvalidBorder: _entity?.formInvalidBorder,
formInvalidBg: _entity?.formInvalidBg,
formValidBorder: _entity?.formValidBorder,
formValidBg: _entity?.formValidBg,
textHeading: _entity?.textHeading,
textLink: _entity?.textLink,
textLinkHover: _entity?.textLinkHover,
signalPrimaryFill: _entity?.signalPrimaryFill,
signalPrimaryBg: _entity?.signalPrimaryBg,
signalPrimaryBorder: _entity?.signalPrimaryBorder,
signalPrimaryText: _entity?.signalPrimaryText,
signalSecondaryFill: _entity?.signalSecondaryFill,
signalSecondaryBg: _entity?.signalSecondaryBg,
signalSecondaryBorder: _entity?.signalSecondaryBorder,
signalSecondaryText: _entity?.signalSecondaryText,
signalTertiaryFill: _entity?.signalTertiaryFill,
signalTertiaryBg: _entity?.signalTertiaryBg,
signalTertiaryBorder: _entity?.signalTertiaryBorder,
signalTertiaryText: _entity?.signalTertiaryText,
signalSuccessFill: _entity?.signalSuccessFill,
signalSuccessBg: _entity?.signalSuccessBg,
signalSuccessBorder: _entity?.signalSuccessBorder,
signalSuccessText: _entity?.signalSuccessText,
signalInfoFill: _entity?.signalInfoFill,
signalInfoBg: _entity?.signalInfoBg,
signalInfoBorder: _entity?.signalInfoBorder,
signalInfoText: _entity?.signalInfoText,
signalDangerFill: _entity?.signalDangerFill,
signalDangerBg: _entity?.signalDangerBg,
signalDangerBorder: _entity?.signalDangerBorder,
signalDangerText: _entity?.signalDangerText,
signalWarningFill: _entity?.signalWarningFill,
signalWarningBg: _entity?.signalWarningBg,
signalWarningBorder: _entity?.signalWarningBorder,
signalWarningText: _entity?.signalWarningText,
signalInvertFill: _entity?.signalInvertFill,
signalInvertBg: _entity?.signalInvertBg,
signalInvertBorder: _entity?.signalInvertBorder,
signalInvertText: _entity?.signalInvertText,
components: _entity?.components,
        ...
        const result = await client.service("figma").patch(_entity._id, _data);
        props.onHide();
        props.alert({ type: "success", title: "Edit info", message: "Info figma updated successfully" });
    ...
    return (
        <Dialog header="Edit Figma" visible={props.show} closable={false} onHide={props.onHide} modal style={{ width: "40vw" }} className="min-w-max scalein animation-ease-in-out animation-duration-1000" footer={renderFooter()} resizable={false}>
            <div className="grid p-fluid overflow-y-auto"
            style={{ maxWidth: "55vw" }} role="figma-edit-dialog-component">
